...
(function ($) {
  ...
  ------------------------------------------------------------------------------------- */
    const type_text = function () {
        ...
        var typed = new Typed(".type-3", {
            strings: [
                "I am highly motivated software engineer with a strong foundation in software engineering and programming principles. Proficient in a variety of platform, languages and embedded systems, with an innate ability to learn and master new technologies and programming languages.",
            ],
            typeSpeed: 3,
            backSpeed: 1,
  ...
  ------------------------------------------------------------------------------------- */
    const modal_down = function () {
        ...
        if (modalNav.length) {
            ...
            $(
                ".modal-menu__backdrop,.title-button-group, .menu-content li a"
            ).on("click", function () {
                close();
            });
        }
        ...
        nav.on("click", function () {
            ...
            if (!parent.hasClass("active")) {
                ...
                if (window.innerWidth <= 1190) {
                    all_element2.hasClass("active")
                        ? wrapper.find(".sticky-sidebar").show()
                        : wrapper.find(".sticky-sidebar").hide();
                }
